...
app.get('/guests/:weddingId', verifyToken, (req, res) => {
...
//1. find all the guests
	...
	Wedding.findById(weddingId)
		.then(doc => {
			...
			console.log(doc.weddingAdminId);
...
app.post('/weddings', verifyToken, (req, res) => {
	const { weddingName, partnerFirstNameA, partnerLastNameA, partnerFirstNameB, partnerLastNameB, startDate, endDate, rsvpDeadline, addressLine1, addressLine2, addressLine3, storyPic, whenWherePic, registryPic, rsvpPic } = req.body;
